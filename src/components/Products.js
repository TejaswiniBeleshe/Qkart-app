...
//   const [checkop,setCheck] = useState(false)
//    const handler = ()=>{
//      localStorage.clear();
//     //  history('/')
...
//        if(text !== ""){
//         let coverted = text.toLowerCase();
//         url = `${url}/search?value=${coverted}`;
//        }
//        console.log(url)
//        setLoad(true);
//        try{
...
//       let isPresent = isItemInCart(items,productId);
//       let check = false;
//       for(let i=0;i<items.length;i++){
//         if(items[i].productId === productId && items[i].qty !== qty){
//           check = true;
//           break;
//         }
//       }
...
//        <TextField className="search-desktop" placeholder="Search for items/categories" value={ip} onChange={(e)=>setInput(e.target.value)}
//         InputProps={{
//           endAdornment: (
...
//           <>
//         {/* <img src="../../public/avatar.png" alt={localStorage.getItem('username')}>Text</img> */}
        
//         <Avatar alt={localStorage.getItem('username')} src="../../public/avatar.png" />
//         <span style={{marginTop:".5rem"}}>{localStorage.getItem('username')}</span>
//         <Button variant="contained" onClick={handler}>LOGOUT</Button>
          
//           </>
//         : <>
//           <Button variant="text" onClick={loginHandle}>LOGIN</Button>
...
//         </Stack>
//       </Header>
//       <TextField className="search-mobile " placeholder="Search for items/categories"
//         id="input-with-icon-textfield" value={ip} onChange={(e)=>setInput(e.target.value)}
//         InputProps={{
//           endAdornment: (
//             <InputAdornment position="end">
//               <Search />
...
//         variant="outlined"
//       />
//        <Grid container sx={{p:1}} style={{border:"1px solid red"}} >
//         {/* Product part */}
//         {
//         localStorage.getItem('username')?<Grid item xs={12} md={9} container>
//         <Grid item className="product-grid" xs={12} style={{border:'1px solid red'}}>
//            <Box className="hero">
...
//            {
//           load?
//           <span className="loading"><CircularProgress color="inherit" id="loader" /><span>Loading products...</span></span>:
//           data.map((ele)=>(
//             <Grid item className="product-grid" xs={6} md={3} style={{border:"1px solid blue"}} >
//                <ProductCard product={ele} items={cartData} products={productData} handleAddToCart={addToCart}/>
//             </Grid>
...
//           data.map((ele)=>(
//             <Grid item className="product-grid" xs={6} md={3} style={{border:"1px solid blue"}} >
//                <ProductCard product={ele} items={cartData} products={productData} handleAddToCard={addToCart}/>
//             </Grid>
...
//          {
//           localStorage.getItem('username')?
//           <Grid item xs={12} md={3} className="cart">
//              <Cart products={productData} checkop={checkop} items={cartData} handleQuantity={addToCart} />
//           </Grid>:""
//          }
//       </Grid>
//       <Footer />
...
//       </Header>
      ...
      //     <span className="loading"><CircularProgress color="inherit" id="loader" /><span>Loading products...</span></span>:
      //     ProductData.map((x)=>(
      //       <Grid item key={x['_id]} className="product-grid" xs={6} md={3} style={{border:"1px solid blue"}} >
      //          <ProductCard product={x} products={productData} handleAddToCart={(e)=>addToCart(e)}/>
      //       </Grid>
      //      ))
      //     }
      //     </Grid>:
      ...
      //     data.map((x)=>(
      //       <Grid item key={x['_id]} className="product-grid" xs={6} md={3} style={{border:"1px solid blue"}} >
      //          <ProductCard product={x} handleAddToCard={(e)=>addToCart(e)}/>
      //       </Grid>
      ...
      //     localStorage.getItem('username')?
      //     <Grid item xs={12} md={3} className="cart">
      //        <Cart products={productData} items={cartData} handleQuantity={onButtonClick} />
      //     </Grid>:""
      //    }
      // </Grid>
      // <Footer />
